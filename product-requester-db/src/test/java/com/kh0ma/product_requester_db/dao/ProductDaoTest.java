...
import com.kh0ma.product_requester_db.dao.generic.GenericDao;
import com.kh0ma.product_requester_db.dao.generic.GenericDaoTest;
import com.kh0ma.product_requester_db.entity.ProductBuilder;
...
public class ProductDaoTest extends GenericDaoTest<Product, Long> {
    ...
    public Product getUpdatedObject(Product updatingObject) {
        ...
        updatingObject.setPrice(updatingObject.getPrice().add(BigDecimal.valueOf(12.99)));
